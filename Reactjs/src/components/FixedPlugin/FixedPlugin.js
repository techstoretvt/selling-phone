        ...
        <Dropdown.Menu>
          ...
          <li className="adjustments-line mt-3">
            ...
            <div className="pull-right">
              {/* <li style={{ backgroundColor: '#000', width: '20px', height: '20px', borderRadius: '50%' }}></li> */}
              <Badge
                // variant="secondary"
              ...
              <Badge
                variant="azure"
                className={color === "azure" ? "active azure" : "azure"}
                onClick={() => setColor("azure")}
              ></Badge>
              <Badge
                variant="green"
                className={color === "green" ? "active green" : "green"}
                onClick={() => setColor("green")}
              ></Badge>
              <Badge
                variant="orange"
                className={color === "orange" ? "active orange" : "orange"}
                onClick={() => setColor("orange")}
              ></Badge>
              <Badge
                variant="red"
                className={color === "red" ? "active red" : "red"}
                onClick={() => setColor("red")}
              ></Badge>
              <Badge
                variant="purple"
                className={color === "purple" ? "active purple" : "purple"}
          ...
          <li>
            <button className="btn btn-warning" onClick={handleClickReset}>Reset</button>
          </li>
        </Dropdown.Menu>
      </Dropdown>
    </div>
