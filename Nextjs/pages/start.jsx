...
const StartServer = () => {
   ...
   const handleCheckStartServer = async () => {
      ...
      if (res?.errCode === 0) {
         ...
         notify('Server TechStoreTvT đã hoạt động', { body: 'Bạn đã có thể truy cập vào website :)' });
      }
   }
                     ...
                     <div className={styles.content}>
                        <div className={styles.left}>
                           <div className={styles.row}>
                              ...
                              <div className={styles.number + ' ' + styles.title}>Number</div>
                        ...
                        <div className={styles.right}>
                           <input value={valueInput}
                              ...
                              placeholder='Nhập số...' type="text" maxLength={4} />
                           <button
